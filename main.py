...
async def cmd_write(msg: Message):
    ...
    try:
        ...
        async with get_pool() as pool:
            ...
            await save_submission(pool, msg.from_user, \"essay\", band, tips,
...
async def handle_voice(msg: Message):
    ...
    try:
        ...
        async with get_pool() as pool:
            await upsert_user(pool, msg.from_user)
            await save_submission(pool, msg.from_user, \"speaking\", band, tips,
...
async def main() -> None:
    ...
    # ← FIX APPLIED: we now accept *all* default update types
    await dp.start_polling(bot)                 # long-polling mode
